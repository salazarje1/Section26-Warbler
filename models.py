...
class Likes(db.Model):
    ...
    def get_likes(cls, user_id):
        likes = cls.query.filter_by(user_id=user_id)
        return [l.message_id for l in likes]
...
class User(db.Model):
    ...
    @classmethod
    def get_user_id(cls, user, following): 
        list = []
        list.append(user)
...
class Message(db.Model):
    ...
    @classmethod
    def get_messages(cls, ids):
        messages = (cls
                .query
                .filter(cls.user_id.in_(ids))
